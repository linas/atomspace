...
MESSAGE(STATUS "duuude dirpa=${MODULE_DIR_PATH}")
MESSAGE(STATUS "duuude fdirpa=${MODULE_FILE_DIR_PATH}")
...
MESSAGE(STATUS "duuude buildpa=${FILE_BUILD_PATH} for ${FILE_NAME}")
...
#MESSAGE(STATUS "duuude build mod=${MODULE_NAME}")
#MESSAGE(STATUS "duuude build files=${SCM_FILES}")
    # Compile the *scm files
    # ADD_CUSTOM_TARGET(${FILE_BUILD_PATH}/${MODULE_NAME}.go ALL)
    ADD_CUSTOM_COMMAND(
...
MESSAGE (STATUS "duude enter guiel module eclaration ========")
  ...
  IF(HAVE_GUILE)
    ...
    IF((DEFINED SCM_FILES) AND (DEFINED SCM_MODULE_DESTINATION))
        ...
        # The name of the SCM file is the name of the first file in the
        # list. If the filename hs slashes (autogenerated) then leave it
        # blank.
MESSAGE (STATUS "duude enterfiles ${SCM_FILES}")
        LIST(GET SCM_FILES 0 SCM_MODULE_FILE)
        STRING(FIND ${SCM_MODULE_FILE} "/" POS)
        IF(POS EQUAL -1)
           STRING(REPLACE ".scm" "" SCM_MODULE ${SCM_MODULE_FILE})
        ENDIF()
MESSAGE (STATUS "duude enter scm_mod ${SCM_MODULE}")
