                                      ...
                                      const HandleMap& gnds)
{
	...
	else
	{
		...
		{
			// The do_evaluate()/do_eval_scratch() above can throw if it
			// is given ungrounded expressions. It can be given ungrounded
			// expressions if no grounding was found, and a final pass, run
			// by the search_finished() callback, puts us here. So handle
